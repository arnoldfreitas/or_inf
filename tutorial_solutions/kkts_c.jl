...
@mapping(m, f1, 2*x[1] - (9/2) + 2*x[1]*l[1] + l[2])
@mapping(m, f2, 2*x[2] - 4 -l[1] + l[2])
@mapping(m, f3, x[2] - x[1]*x[1])
@mapping(m, f4, -x[1] - x[2] + 6)

@complementarity(m, f1, x[1])
@complementarity(m, f2, x[2])
@complementarity(m, f3, l[1])
@complementarity(m, f4, l[2])
