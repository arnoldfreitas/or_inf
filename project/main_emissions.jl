...
@variable(ESM,Emissions[technologies]>=0) # kgCO2e
@variable(ESM,CostByTechnology[technologies]>=0) # Eur
@variable(ESM,Production[technologies, fuels] >= 0) # TWh
@variable(ESM,Capacity[technologies] >=0) # TWh
@variable(ESM,Use[technologies, fuels] >=0) # TWh
@variable(ESM,UnservedDemand[fuels] >= 0) # TWh
...
# Max Capacities
MaxCapacity = Dict(zip(technologies, [100, 71, 20, 4.3, 7.5, Inf, Inf, Inf, 37, Inf, Inf, Inf, Inf, Inf, Inf]*1e3)) # in MW, constraint based on condition or sufficiently high value (1e9)
# MaxCapacity = Dict(zip(technologies, [1000, 71, 20, 4.3, 7.5, Inf, Inf, Inf, 37, Inf, Inf, Inf, Inf, Inf, Inf]*1e3)) # in MW, constraint based on condition or sufficiently high value (1e9)
# MaxCapacity = Dict(zip(technologies, [Inf, Inf, Inf, 4.3, Inf, Inf, Inf, 37, Inf, Inf, Inf, Inf, Inf, Inf]*1e3)) # in MW, constraint based on condition or sufficiently high value (1e9)
...
CSV.write("results/results_emissions_32.csv", df)
